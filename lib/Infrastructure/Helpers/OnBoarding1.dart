...
import '../../presentation/Screens/AuthSection/welcome_screen.dart';
      ...
      pages: [
        PageViewModel(
          ...
          image: Padding(
            ...
            child: Image.asset("assets/Images/manageshops.png"),
          ),
          decoration: pageDecoration,
        ),
        PageViewModel(
          title: "Earn handsome Income",
          body: "Quickly Transfer units safely to friends and family.",
          image: Padding(
            padding: const EdgeInsets.only(top: 100, left: 30, right: 30),
            child: Image.asset("assets/Images/paymennts.png"),
          ),
          decoration: pageDecoration,
        ),
        PageViewModel(
